...
Welcome to the GeoAI on HPC Workshop, where we'll explore the evolving landscape of Geospatial Artificial Intelligence (GeoAI) on High-Performance Computing (HPC) environments. 

1. **Get Started with GeoAI.** We'll cover the foundational concepts of GeoAI, introduce what typical GeoAI tasks are and how AI are applied to geospatial data like satellite imagery. 
